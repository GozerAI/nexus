...
> Shared providers, memory, RAG, discovery, and observability for higher-level systems such as c-suite
...
Nexus does **not** own organizational strategy, executive decision-making, or company direction. Those concerns belong in an external control plane such as `c-suite`.
...
- [Shared Infrastructure Role](docs/architecture/SHARED_INFRASTRUCTURE.md)
