...
@pytest.mark.asyncio
async def test_health_endpoint_reports_alive():
...
@pytest.mark.asyncio
async def test_ready_endpoint_reports_ready_runtime():
    """Readiness probe returns 200 when infrastructure is healthy."""
