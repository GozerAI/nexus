...
from nexus.core.models.ollama_provider import OllamaProvider
from nexus.core.models.runpod_serverless_provider import RunPodServerlessProvider
from nexus.core.models.openrouter_provider import OpenRouterProvider
...
class ModelFactory:
    ...
    _providers: Dict[ModelProvider, Type[BaseModel]] = {
        ...
        ModelProvider.RUNPOD_SERVERLESS: RunPodServerlessProvider,
